...
impl FfiFipsBle {
    #[uniffi::constructor]
    pub fn new(app: Arc<FfiApp>) -> Arc<Self> {
        let runtime = tokio::runtime::Builder::new_multi_thread()
            .worker_threads(1)
            .enable_time()
            .build()
            .expect("create FIPS BLE bridge runtime");
        ...
        app.background_tx
            ...
            .expect("attach FIPS BLE bridge to Iris core");
        reply_rx
            .recv_timeout(Duration::from_secs(2))
            .expect("Iris core did not attach FIPS BLE bridge")
            .expect("Iris core rejected FIPS BLE bridge");
        Arc::new(Self {
            runtime,
