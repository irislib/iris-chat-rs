...
pub(super) const PENDING_DEVICE_LINK_RETRY_SECS: u64 = 2;
pub(super) const PENDING_DEVICE_LINK_CONNECT_TIMEOUT_SECS: u64 = 2;
pub(super) const PENDING_DEVICE_LINK_FETCH_TIMEOUT_SECS: u64 = 2;
