...
App-level notable changes for Iris Chat in this repository.

Rust crate-only changes live in `core/CHANGELOG.md`. Android/Zapstore store
metadata is mirrored in `ZAPSTORE_RELEASE_NOTES.md`.
